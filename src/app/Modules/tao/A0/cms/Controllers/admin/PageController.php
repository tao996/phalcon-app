...
class PageController extends BaseController
{
    ...
    public function addAction()
    {
        if ($this->request->isPost()) {
            ...
            Data::mustHasSet($data, $keys, ['sort', 'tag']);
            ...
            Db::transaction(function () use ($data, $model) {
                ...
                if ($cc->create()) {
                    ...
                    if ($model->create() === false) {
                        throw new \Exception('save page failed:' . $model->getErrors(true));
                    }
                } else {
                    throw new \Exception('save content failed:' . $cc->getErrors(true));
                }
            });
    ...
    public function editAction()
    {
        ...
        if ($this->request->isPost()) {
            ...
            Db::transaction(function () use ($page, $cc) {
                ...
                if (!$page->save()) {
                    throw new \Exception('save page failed:' . $page->getErrors(true));
                }
            });
