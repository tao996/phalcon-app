...
class BaseRbacController extends BaseResponseController
{
    ...
    /**
     * @var array 当前控制器允许访问的 action
     */
    public array $enableActions = [];
    /**
     * @var array 当前控制器取消的操作（不是每个控制器都有 add/edit/delete）
     */
