...
if (!function_exists('url')) {
    /**
     * 通常用来拼接以便生成模块 URLs 地址; 更多功能请使用 \Phax\Support\Facades\Url
...
if (!function_exists('viewData')) {
    function viewData(string $path = '', $default = '')
    {
        ...
        return empty($path) ? $viewData : \Phax\Utils\Data::findWithPath($viewData, $path, $default);
    }
}
...
if (!function_exists('__')) {
    ...
    {
        return \Phax\I18n\Transaction::get($key, $placeholders, $defMessage);
    }
}
...
if (!function_exists('ddRouterMatch')) {
    ...
    {
        dd(\Phax\Foundation\Router::matchOptions());
    }
}