 ...
 * @method static array group(array $collection, mixed $method) 没啥用：将子元素的值作为新数组中子元素的键，结果变成三维数组；你可能需要使用 Data::reGroup 来代替
 ...
 * @method static string random(int $type = 0, int $length = 8) 随机 RANDOM_ALNUM 数字字母|RANDOM_ALPHA字母|RANDOM_DISTINCT验证码|RANDOM_HEXDEC|RANDOM_NOZERO|RANDOM_NUMERIC
